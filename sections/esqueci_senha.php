...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user) {
        ...
        try {
            ...
            $mail->setFrom('dexter.craus@gmail.com', 'Controle de Bolos');
            $mail->addAddress($email, $user['nome']);
            $mail->isHTML(true);
            $mail->Subject = 'Redefinição de senha - Controle de Bolos';
            $mail->Body = "
<!DOCTYPE html>
<html lang='pt-br'>
<head>
...
<div class='email-container'>
    <div class='header'>
        ...
        <h2>Controle de Bolos</h2>
    </div>

    <div class='content'>
        <h3>Olá, {$user['nome']}!</h3>
        <p>Você solicitou a redefinição da sua senha no <strong>Controle de Bolos</strong>.</p>
